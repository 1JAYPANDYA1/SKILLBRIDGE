...
=======
            const response = await fetch(`${myIP}/vid/generate-mcqs`, {
>>>>>>> 2cca578 (Initial commit or reconnect)
                method: 'POST',
                headers: {
...
=======
                const response2 = await fetch(`${myIP}/vid/generate-mcqs`, { method: 'GET', credentials: 'include' });
>>>>>>> 2cca578 (Initial commit or reconnect)
...
=======
                const response = await axios.post(`${myIP}/vid/update-chapter-course-progress`, {
>>>>>>> 2cca578 (Initial commit or reconnect)
                    userId,
                    videoId,
                    chapterId,
...
=======
                const response2 = await axios.post(`${myIP}/vid/update-progress`, {
>>>>>>> 2cca578 (Initial commit or reconnect)
                    userId,
                    courseId
                })
