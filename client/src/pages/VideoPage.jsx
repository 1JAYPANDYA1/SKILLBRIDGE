...
=======
                const videoResponse = await axios.post(`${myIP}/vid/video-details`,{userId,videoId});
>>>>>>> 2cca578 (Initial commit or reconnect)
...
=======
                const progressResponse = await axios.post(`${myIP}/vid/course-progress/${courseId}`, { userId });
>>>>>>> 2cca578 (Initial commit or reconnect)
...
=======
            await axios.post(`${myIP}${endpoint}`, { videoId, userId }, {
>>>>>>> 2cca578 (Initial commit or reconnect)
            });
        } catch (error) {
