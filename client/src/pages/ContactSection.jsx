...
const ContactSection = () => {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto text-center pt-20 bg-indigo-100">
      ...
      <section id="contact" className="bg-gradient-to-br bg-indigo-100 pt-30 pb-40">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap -mx-4">

            {/* Contact Info Section */}
            <div className="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
              <div className="bg-indigo-200 rounded-lg shadow-lg p-8 border border-indigo-950">
            ...
            <div className="w-full lg:w-1/2 px-4">
              <form onSubmit={handleSubmit} className="bg-indigo-200 rounded-lg shadow-lg p-7 border border-indigo-950">
                <div className="mb-2">
                  <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2 bg-indigo-200 ">
                    Your Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-2">
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-2 bg-indigo-200">
                    Your Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="mb-2">
                  <label htmlFor="subject" className="block text-sm font-medium text-gray-700 mb-2 bg-indigo-200">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-2">
                  <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-2 bg-indigo-200">
                    Message
                  </label>
                  <textarea
                    id="message"
